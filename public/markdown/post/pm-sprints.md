...
- Slack channel per capstone group
    - These are for you all - use them!
    - Pick a team name and tell us. We'll change the channel name accordingly
- Slack (lists) - our project management software
    - We will be put a list in the Slack channel for each sprint
...
- If you are unable to complete work on a ticket because it is waiting on something else, change add blocked to the beginning of your ticket
